...
--
-- Host: localhost:3306
-- Generation Time: Jun 14, 2026 at 04:46 PM
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('gcash','bank_transfer','credit_card','cash_on_delivery','maya') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `energy_rating` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('customer','admin','superadmin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'customer',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `users` (`id`, `email`, `password_hash`, `first_name`, `last_name`, `phone`, `role`, `is_active`, `otp`, `otp_expires_at`, `email_verified`, `last_login_at`, `created_at`, `updated_at`) VALUES
('4b0df579-adc8-41a5-9aef-08cdc12ad534', 'saban@rgtrading.com', '$2a$12$XyYaiwRAc/SQGi1fnlu2m.ms5eRWVMvlrVZBPjeEtmO4Td9fkZ6ee', 'saban', 'chriistan', NULL, 'customer', 1, NULL, NULL, 0, NULL, '2026-05-28 23:06:37', '2026-05-28 23:06:37'),
('62e17334-68a8-4940-9425-289a8c058471', 'dog@rgtrading.com', '$2a$12$Buy0FrfuN0CI5cRNFClaWuqjVMzm9CMRZohZpz6Iox4YokNkQ7ie6', 'dog', 'cat', NULL, 'customer', 1, NULL, NULL, 0, NULL, '2026-05-28 23:07:55', '2026-05-28 23:07:55'),
('af9c6e00-a94f-44f5-a34b-700c9c03d6fc', 'juan@rgtrading.com', '$2a$12$tdrJKg6tSrlIq0bvzzJGGOpKSOiQ7bt2kOxrbi4QikDRUhDAbB31O', 'juan', 'example', NULL, 'customer', 1, NULL, NULL, 0, NULL, '2026-05-28 11:12:42', '2026-05-28 12:10:16');
...
ALTER TABLE `_migrations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_migration_file` (`filename`);
